...
class Ideal_principal(Ideal_generic):
    ...
    def saturation(self, other):
        r"""
        Return the saturation and the saturation exponent of this ideal
        ...
        EXAMPLES::
            ...
            sage: I = ZZ.ideal(2*3^3*5^5)
            sage: I.saturation(3)
            (Principal ideal (6250) of Integer Ring, 3)

            sage: I.saturation(15)
            (Principal ideal (2) of Integer Ring, 5)
