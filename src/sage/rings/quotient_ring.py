...
class QuotientRingIdeal_generic(ideal.Ideal_generic):
    ...
    def cover_ideal(self):
        r"""
        Return the covering ideal for this ideal.
        ...
        EXAMPLES::
            ...
            sage: R.<x, y> = QQ[]
            sage: B = R.quotient(x^2 + y)
            sage: J = B.ideal([x])
            sage: J
            Ideal (xbar) of Quotient of Multivariate Polynomial Ring in x, y over Rational Field by the ideal (x^2 + y)
            sage: J.cover_ideal()
            Ideal (x^2 + y, x) of Multivariate Polynomial Ring in x, y over Rational Field
